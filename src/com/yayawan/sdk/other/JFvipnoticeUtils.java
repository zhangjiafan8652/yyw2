...
public class JFvipnoticeUtils {
	...
	public void getNotice(final Activity mActicity) {
			...
			Yayalog.loger("获取vip公告：" + ViewConstants.NOTICEURL);
			try {
						...
						try {
						 ...
						 if (msg.contains("success")) {
								...
								mActicity.runOnUiThread(new Runnable() {
									...
									public void run() {
										// TODO Auto-generated method stub
										new Announcevipment_dialog(mActicity,
												data).dialogShow();
				...
				Yayalog.loger(ViewConstants.VIPNOTICEURL + "/?" + pingjie);
				yibuhttputils.runHttp(ViewConstants.VIPNOTICEURL + "/?" + pingjie, "",
